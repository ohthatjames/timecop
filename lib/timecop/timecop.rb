...
class Timecop
  ...
  class << self
    ...
    def ignore_microseconds=(ignore)
      instance.send(:ignore_microseconds=, ignore)
    end

    def ignore_microseconds
      instance.send(:ignore_microseconds)
    end
