...
class TestTimeStackItem < Minitest::Test
  ...
  def test_new_with_no_args_ignoring_milliseconds
    t = safe_time_now
    y, m, d, h, min, s = t.year, t.month, t.day, t.hour, t.min, t.sec
    stack_item = nil
    ignoring_milliseconds(true) do
      stack_item = Timecop::TimeStackItem.new(:freeze)
    end
  ...
  def test_new_with_no_args_with_milliseconds
    t = safe_time_now
    y, m, d, h, min, s, usec = t.year, t.month, t.day, t.hour, t.min, t.sec, t.usec
    stack_item = nil
    ignoring_milliseconds(false) do
      stack_item = Timecop::TimeStackItem.new(:freeze)
    end
  ...
  def test_new_with_integer_ignoring_milliseconds
    t = safe_time_now
    y, m, d, h, min, s = t.year, t.month, t.day, t.hour, t.min, t.sec
    stack_item = nil
    ignoring_milliseconds(true) do
  ...
  def test_new_with_integer_with_milliseconds
    t = safe_time_now
    y, m, d, h, min, s, usec = t.year, t.month, t.day, t.hour, t.min, t.sec, t.usec
    stack_item = nil
    ignoring_milliseconds(false) do
  ...
  def test_new_with_float_ignoring_milliseconds
    t = safe_time_now
    y, m, d, h, min, s = t.year, t.month, t.day, t.hour, t.min, t.sec
    stack_item = nil
    ignoring_milliseconds(true) do
  ...
  def test_new_with_float_with_milliseconds
    t = safe_time_now
    y, m, d, h, min, s, usec = t.year, t.month, t.day, t.hour, t.min, t.sec, t.usec
    stack_item = nil
    ignoring_milliseconds(false) do
  ...
  def ignoring_milliseconds(ignore, &block)
    original_ignore_milliseconds = Timecop.ignore_milliseconds
    Timecop.ignore_milliseconds = ignore
    block.call
  ensure
    Timecop.ignore_milliseconds = original_ignore_milliseconds
  end
end
